...
Feature: Consumption Management
  ...
  Scenario: Add a consumption with multiple products
    ...
    And I increase the quantity of "Txakoli Getariako" to 2
    ...
    And I should see "Txakoli Getariako" in the items table with quantity 2
    And I should see "Kalea Garagardoa" in the items table with quantity 1
  ...
  Scenario: Cancel consumption confirmation
    ...
    Then the cart should still contain "Txakoli Getariako"
