...
const eu = {
  ...
  signupFieldShortDescription: "Deskribapen laburra (aukerakoa, gehienez 250 karaktere)",
  ...
  signupValidationRequired: "Derrigorrezkoa da.",
  signupValidationEmailInvalid: "Helbide elektroniko baliogabea.",
  signupValidationPasswordTooShort: "Gutxienez 8 karaktere behar dira.",
  signupValidationPasswordTooLong: "Gehienez 128 karaktere.",
  signupValidationText200Max: "Gehienez 200 karaktere.",
  signupValidationShortDescriptionMax: "Gehienez 250 karaktere.",
  signupValidationPhoneMax: "Gehienez 80 karaktere.",
  signupValidationAddressMax: "Gehienez 500 karaktere.",
  signupValidationAcronymMax: "Gehienez 3 letra.",
  signupSubdomainInvalid: "Azpidomeinu baliogabea edo erreserbatua.",
  signupErrorTooManyRequests: "Eskaera gehiegi. Saiatu beranduago.",
  signupErrorInvalidPayload: "Datu baliogabeak. Egiaztatu eremuak.",
  signupErrorSubdomainRequired: "URLrako azpidomeinu baliagarria behar da.",
  signupErrorCouldNotComplete:
    "Ezin izan da prozesamendua amaitu (adib. azpidomeinua hartuta). Saiatu berriro.",
...
const es = {
  ...
  signupFieldShortDescription: "Descripción breve (opcional, máx. 250 caracteres)",
  ...
  signupValidationRequired: "Obligatorio.",
  signupValidationEmailInvalid: "Correo electrónico no válido.",
  signupValidationPasswordTooShort: "Mínimo 8 caracteres.",
  signupValidationPasswordTooLong: "Máximo 128 caracteres.",
  signupValidationText200Max: "Máximo 200 caracteres.",
  signupValidationShortDescriptionMax: "Máximo 250 caracteres.",
  signupValidationPhoneMax: "Máximo 80 caracteres.",
  signupValidationAddressMax: "Máximo 500 caracteres.",
  signupValidationAcronymMax: "Máximo 3 letras.",
  signupSubdomainInvalid: "Subdominio no válido o reservado.",
  signupErrorTooManyRequests: "Demasiadas solicitudes. Prueba más tarde.",
  signupErrorInvalidPayload: "Datos no válidos. Revisa los campos.",
  signupErrorSubdomainRequired: "Se requiere un subdominio válido para la URL de tu organización.",
  signupErrorCouldNotComplete:
    "No se ha podido completar el registro (p. ej. subdominio ocupado). Inténtalo de nuevo.",
