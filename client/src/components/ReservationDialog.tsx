...
import { Plus, Calendar as CalendarIcon, Users, Utensils } from 'lucide-react';
      ...
      <DialogContent className="max-w-lg" data-testid="dialog-content">
        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-end gap-2 pt-2">
            ...
            <Button onClick={handleCreateReservation} data-testid="button-save-reservation" disabled={!formData.name || loading}>
