...
import { Plus, Edit2, Trash2, Package, Coffee, Wine, Beer, Cake, Pizza, Sandwich, Utensils, ChefHat, IceCream, Apple, Carrot, ShoppingBag } from 'lucide-react';
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <div className="flex items-center justify-center w-12 h-12 rounded-lg" style={{ backgroundColor: category.color + '20' }}>
                    {(() => {
                      const IconComponent = getIconComponent(category.icon);
                      return <IconComponent className="h-6 w-6" style={{ color: category.color }} />;
                    })()}
                  </div>
                  <div>
