...
- Option to associate with active reservation
- Real-time cost calculation
- Confirmation of consumption registration

### Story 2: Register Event Consumption
**As a** Bazkidea or Laguna  
**I want to** register products consumed during an event  
**So that** all event-related costs are captured  

**Acceptance Criteria:**
- Link consumption to active reservation
- Product selection from event inventory
- Multiple consumption entries for same event
- Automatic association with responsible Bazkidea
- Option to add notes for special items

### Story 3: View Consumption History
**As a** Bazkidea or Laguna  
...
- Filter by date, user, product, or event
- Ability to correct consumption entries
- Real-time sales analytics
- Export consumption reports for accounting

### Story 5: Close Event Account
**As a** Bazkidea or Laguna  
**I want to** close the account for an event  
**So that** final costs are calculated and added to my credit  

**Acceptance Criteria:**
- Summary of all consumptions for the event
- Include reservation costs and consumption costs
- Final total calculation
- Confirmation before closing
- Automatic addition to Bazkidea's pending credits

### Story 6: Consumption Categories
**As a** Sotolaria  
