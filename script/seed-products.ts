...
export async function seedProducts(dbConn: SeedDb) {
  ...
  const demoProducts: DemoProductSeed[] = [
    ...
    },
    {
      ...
      isActive: true,
      stockMode: "manual",
      catalogImageUrl: "/catalog/products/ardo-zuria-kopa.png",
    },
    {
      name: "Ura Mineral",
    ...
    },
    {
      ...
      isActive: true,
      stockMode: "auto",
      catalogImageUrl: "/catalog/products/chips.png",
    },
    {
      name: "Oliba Berdea",
      ...
      isActive: true,
      stockMode: "auto",
      catalogImageUrl: "/catalog/products/olives.png",
    },
    {
      name: "Kafea",
    ...
    {
      name: "Radler Garagardoa",
      description: "Radler garagardoa, garagardoa+limoia, 330ml botila",
      categoryId: "",
      price: "2.50",
      stock: "24",
      unit: "unit",
      ...
      isActive: true,
      stockMode: "auto",
      catalogImageUrl: "/catalog/products/radler.png",
    },
    {
      name: "Ardo Beltza",
      description: "Ardo beltza, edalontzi arrunta",
      categoryId: "",
      price: "2.00",
      stock: "30",
      unit: "unit",
      ...
      isActive: true,
      stockMode: "auto",
      catalogImageUrl: "/catalog/products/ardo-beltza-arrunta.png",
    },
    {
      name: "Ardo Zuria",
      description: "Ardo zuria, edalontzi arrunta",
      categoryId: "",
      price: "2.00",
      stock: "30",
      unit: "unit",
      ...
      isActive: true,
      stockMode: "auto",
      catalogImageUrl: "/catalog/products/ardo-zuria-arrunta.png",
    },
    {
      name: "Ardo Ondua",
      description: "Ardo beltza krianza, kopa",
      categoryId: "",
      price: "3.50",
      stock: "15",
      unit: "unit",
      ...
      isActive: true,
      stockMode: "auto",
      catalogImageUrl: "/catalog/products/ardo-beltza-kopa.png",
    },
    {
      name: "Sagardoa",
      description: "Sagardoa, edalontzi arrunta",
      categoryId: "",
      price: "2.50",
      stock: "20",
      unit: "unit",
      ...
      isActive: true,
      stockMode: "auto",
      catalogImageUrl: "/catalog/products/sagardoa.png",
    },
    {
      name: "Kafesnea",
      description: "Kafea esnearekin",
      categoryId: "",
      price: "1.80",
      stock: "100",
      unit: "unit",
      ...
      isActive: true,
      stockMode: "auto",
      catalogImageUrl: "/catalog/products/kafesnea.png",
    },
  ];
