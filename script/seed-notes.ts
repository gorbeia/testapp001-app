...
async function seedNotes() {
  ...
  try {
      ...
      },
      {
        ...
        messages: [
          ...
          },
          {
            ...
            content: 'Por favor, recuerda cerrar los consumos al final del mes. Así las deudas se calcularán correctamente.'
          }
        ]
      },
        ...
        messages: [
          {
            ...
            content: 'Ongi etorri txoko berriara! Gaurtik zure gune pribatua erabil dezakezu ekintzak antolatzeko.'
          }
        ]
      },
      {
        ...
        messages: [
          {
            ...
            content: 'El sistema estará en mantenimiento mañana de 10:00 a 12:00. Disculpen las molestias.'
          }
        ]
      },
      ...
      // More bilingual notes for variety
      {
        ...
        messages: [
          ...
          },
          {
            ...
            content: 'Hoy se han añadido nuevos productos: sidra natural y queso de pastor nuevo. ¡Pruébalos!'
          }
        ]
      },
      {
        ...
        messages: [
          ...
          },
          {
            ...
            content: 'El miércoles de 22:00 a 23:00 habrá mantenimiento del sistema. El servicio no estará disponible durante ese tiempo.'
          }
        ]
      }
    ];
    ...
    const existingNotes = await db.select().from(notes)
      .where(eq(notes.societyId, society.id));
    ...
    const basqueOnlyCount = sampleNotes.filter(note => note.messages.length === 1 && note.messages[0].language === 'eu').length;
    const spanishOnlyCount = sampleNotes.filter(note => note.messages.length === 1 && note.messages[0].language === 'es').length;
